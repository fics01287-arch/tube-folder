...
| 4단계 | 마무리 다듬기 — 있으면 좋지만 없어도 동작에 지장 없는 항목, 여유 있을 때 처리 | 9/16 완료 (2026-08-29 매뉴얼 불일치 조사로 4개 신규 추가, 2026-08-30 나머지 4개도 착수 승인(8개 전체 작업순서 확정) + 1/8 휴지통 복원 전용 버튼 구현·검증 완료) |
...
| 4. 다듬기 | 다중 선택 + 일괄 이동/삭제 | 중간 | ⬜ 미착수 (작업순서 2/8, 2026-08-30 산들 착수 승인) |
...
- [ ] **다중 선택(Ctrl/Shift+클릭) + 일괄 이동/삭제** (신설 2026-08-29, 매뉴얼-실제 기능 불일치 조사 중 도출한 추천 기능 1순위 — 5단계 "사용자 매뉴얼 — 실제 기능과 불일치하는 부분 정리" 항목 C절 참고) — **작업순서 2/8, 2026-08-30 산들 착수 승인**
