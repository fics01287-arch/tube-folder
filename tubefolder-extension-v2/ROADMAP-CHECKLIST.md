...
| 5. 출시 준비 | 개인정보처리방침 작성 | 낮음~중간 | 🔧 진행중 (2026-08-15) — 문서 4종 작성·`public/legal/`로 배포 경로 배치·빌드 검증 완료, 결제 관련 법적 신고 요건 확인은 남음 |
| 5. 출시 준비 | 다국어(i18n) 지원 준비 | 낮음~중간 | ⬜ 미착수 (신설 2026-07-21) |
| 5. 출시 준비 | Chrome 웹 스토어 비공개(Unlisted) 등록 | 낮음~중간 | ⬜ 미착수 (신설 2026-07-28) |
...
- [ ] **개인정보처리방침 작성** (신설 2026-07-21, 앱개발지침 §7 반영)
  ...
  - **남은 일**: 결제 관련 법적 신고 요건 확인(세무·전자상거래법 등)은 아직 미착수.
  - 복잡도: 낮음~중간
